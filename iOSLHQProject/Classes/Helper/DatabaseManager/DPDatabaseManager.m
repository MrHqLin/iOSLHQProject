...
- (void)getFilePathWithFileName:(NSString *)fileName
{
    ...
    _dbFilePath = [[NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES) objectAtIndex:0] stringByAppendingPathComponent:KDATABASENAME];
}
