...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        _pointA.backgroundColor=[UIColor redColor];
         _pointB.backgroundColor=[UIColor redColor];
         _pointC.backgroundColor=[UIColor redColor];
         _pointD.backgroundColor=[UIColor redColor];
        
        //middle
        _pointE.backgroundColor=[UIColor redColor];
        _pointF.backgroundColor=[UIColor redColor];
        _pointG.backgroundColor=[UIColor redColor];
        _pointH.backgroundColor=[UIColor redColor];
...
//        CGContextSetRGBFillColor(context, 0.0f, 0.0f, 0.0f, 0.7f);
        ...
        if([self checkForNeighbouringPoints:currentIndex]>=0 ){
            frameMoved=YES;
             CGContextSetRGBStrokeColor(context, 31/255.0, 180/255.0, 42/255.0, 1.0f);
