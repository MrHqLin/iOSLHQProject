...
@interface LHQCollectionVC () <LHQVerticalFlowLayoutDelegate>

@end

@implementation LHQCollectionVC

- (void)viewDidLoad {
    [super viewDidLoad];
    
    [self setupBaseLHQCollectionViewControllerUI];
    
    [self.collectionView registerClass:[UICollectionViewCell class] forCellWithReuseIdentifier:NSStringFromClass([UICollectionViewCell class])];
    
}

- (void)setupBaseLHQCollectionViewControllerUI
{
...
{
    UIEdgeInsets contentInset = self.collectionView.contentInset;
    contentInset.bottom -= self.collectionView.mj_footer.lhq_height;
...
{
    LHQVerticalFlowLayout *myLayout = [[LHQVerticalFlowLayout alloc] initWithDelegate:self];
    return myLayout;
}
